...
- `code_julia/lecture_10_05_SequenceSpace_BrockMirman_Lux.ipynb`
- `code_julia/lecture_10_05b_SequenceSpace_IRBC_Lux.ipynb`
- `code_julia/lecture_10_06_SequenceSpace_KrusellSmith_Lux.ipynb`
- `code_julia/lecture_10_KrusellSmith_Tutorial_CPU_Lux.ipynb`
...
parity. Do not let the Jupyter notebooks produce output churn as a side effect of
