...
- `code_julia/lecture_07_01_AutoDiff_Analytical_Examples_Lux.jl`
- `code_julia/lecture_07_02_Brock_Mirman_AutoDiff_DEQN_Lux.jl`
- `code_julia/lecture_07_03_Brock_Mirman_Uncertainty_AutoDiff_DEQN_Lux.jl`
- `code_julia/lecture_07_04_IRBC_AutoDiff_DEQN_Lux.jl`
...
"..", "..", "julia"))` and imports `DLEFJulia`. Keep it as a Pluto `.jl`
notebook, not a Jupyter/IJulia replacement.
...
The checked-in Python notebooks and Julia Pluto files are teaching artifacts;
