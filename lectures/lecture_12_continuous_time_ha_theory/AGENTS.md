...
Lecture 12 is the theory-only continuous-time heterogeneous-agent lecture. It
covers Ito calculus, Hamilton-Jacobi-Bellman equations, Kolmogorov-forward
equations, equilibrium, and the master equation.

## Map

- `README.md` is the local index.
- `slides/lecture_12_continuous_time_ha_theory.tex` is the source of truth for
